...
<template functional>
  ...
  >
    ...
    <vs-dropdown-menu class="w-32">
      <vs-dropdown-item
        @click="
          listeners.timeDurationChanged
            ? {
                timeDurationChanged: listeners.timeDurationChanged(
                  'last-28-days'
                ),
              }
            : null
        "
        >Last 28 days</vs-dropdown-item
      >
      <vs-dropdown-item
        @click="
          listeners.timeDurationChanged
      ...
      <vs-dropdown-item
        @click="
          listeners.timeDurationChanged
            ? {
                timeDurationChanged: listeners.timeDurationChanged('last-year'),
              }
            : null
        "
