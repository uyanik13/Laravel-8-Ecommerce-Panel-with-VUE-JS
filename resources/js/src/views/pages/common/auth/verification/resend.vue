                        ...
                        <div class="vx-col sm:w-full md:w-full lg:w-1/2 mx-auto self-center d-theme-dark-bg">
                            <div class="p-8">
                                <div class="vx-card__title mb-8">
                                    ...
                                    <p>Lütfen e-posta adresinizi girin, Hesap Onaylama Linkini Tekrar Gönderelim.</p>
                                </div>
                                ...
                                <vs-button @click="send()" :loading="form.busy" class="float-right px-4 w-full md:w-auto mt-3 mb-8 md:mt-0 md:mb-0">Onay Linki Gönder</vs-button>
                            </div>
                        </div>
                    </div>
                </div>
