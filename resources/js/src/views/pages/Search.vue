...
<template>
  <div id="search-page">
    ...
    <div
      class="search-page__serch-menu flex flex-wrap items-center md:justify-between mt-8"
    >
        ...
        <vx-card class="search-page__search-results lg:p-2">
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <span
                    ...
                    :key="infoIndex"
                    >{{ info }}
                    <span v-if="infoIndex < result.metaData.info.length - 1"
                      >|</span
                    ></span
                  >
                </div>
              ...
              <span>{{
                result.description | truncate(225) | tailing("...")
              }}</span>
              <!-- SITE LINKS -->
              <div class="vx-row mt-6" v-if="result.sitelinks">
                ...
                >
                  ...
                  ><br />
                  <p>
                    {{ sitelink.description | truncate(50) | tailing("...") }}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="vx-col md:w-2/5 lg:w-1/3 w-full mb-base">
        <vx-card card-border class="bg-transparent no-shadow">
          ...
          <div class="knowledge-panel__meta-list mt-6">
            ...
            >
              <p>
                <span class="font-medium mr-2">{{ meta.name }}:</span>
                {{ meta.value }}
              </p>
            </div>
          </div>
          <div class="knowledge-panel-suggestions mt-6">
            ...
            <div class="knowledge-panel__suggested-list flex flex-wrap">
              <div
                ...
                :key="search.name"
              >
                <a :href="search.url" target="_blank" rel="nofollow"
                  ><img
                    :src="search.img"
  ...
  data() {
    return {
      ...
      knowledgePanel: {
        ...
        description:
          "Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard can be used for any type of web applications: Project Management, eCommerce backends, CRM, Analytics, Fitness or any custom admin panels.",
        info: [
      ...
      searchResults: [
        {
          ...
          resultUrl: "https://1.envato.market/uyanik13_portfolio",
          metaData: {
            ratings: 5,
          ...
          description:
            "Cake sesame snaps cupcake gingerbread danish I love gingerbread. Apple pie pie jujubes chupa chups muffin halvah lollipop. Chocolate cake oat cake tiramisu marzipan sugar plum. Donut sweet pie oat cake dragée fruitcake cotton candy lemon drops. Sweet roll wafer bear claw tiramisu oat cake.",
          sitelinks: [
            {
              title: "Dashboard",
              url: "https://1.envato.market/modern_admin",
