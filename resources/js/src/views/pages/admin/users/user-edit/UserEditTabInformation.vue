    ...
    <div class="vx-row">
      <div class="vx-col w-full md:w-1/2">
        ...
        <div class="flex items-end">
          ...
          <span class="leading-none font-medium">{{$t('password_management')}}</span>
        </div>
...
<!--          </div>-->
          ...
          <vs-input class="w-full mb-base" label-placeholder="Eski Şifre" v-model="old_password" />
          <vs-input class="w-full mb-base" label-placeholder="Yeni Şifre" v-model="new_password" />
          <vs-input class="w-full mb-base" label-placeholder="Yeni Şifre Onayı" v-model="confirm_new_password" />
