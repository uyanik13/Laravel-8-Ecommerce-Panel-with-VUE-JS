...
<template>
    <div id="data-list-thumb-view" class="data-list-container">
        ...
        >
                ...
                >
                    ...
                    >
                        <span class="mr-2"
                            ...
                            -
                            {{
                                blogPosts.length - currentPage * itemsPerPage >
                                0
            ...
            <template slot="thead">
                <vs-th sort-key="title">{{ $t("productImage") }}</vs-th>
                <vs-th sort-key="title">{{ $t("productName") }}</vs-th>
                <vs-th sort-key="url">{{ $t("productUrl") }}</vs-th>
                <vs-th sort-key="price">{{ $t("Price") }}</vs-th>
                <vs-th sort-key="price">{{ $t("DiscountedPrice") }}</vs-th>
