  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    >
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="slug">{{ $t("postUrl") }}</vs-th>
          ...
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            <vs-td>
              <p class="product-name font-medium truncate">
                {{
                  tr.category.title ? tr.category.title[locale] : tr.category_id
                }}
              </p>
            </vs-td>
            <vs-td>
...
<script>
import adminPostSidebar from "./adminPostSidebar.vue";
