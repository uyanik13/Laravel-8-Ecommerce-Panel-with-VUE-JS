                ...
                :label="$t(locale)"
                    ...
                    <!--  CATEGORY -->
                     ...
                     <v-select
                            ...
                            :getOptionLabel="option => option.title? option.title[locale] : null"
                            :filterable="true"/>

                    <vs-input :label="$t('projectPublishDate')" v-model="options[locale].publishDate" class="mt-5 w-full" name="projectPublishDate"  />
                    <vs-input :label="$t('client')" v-model="options[locale].client" class="mt-5 w-full" name="client"  />
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                ...
                status_choices:
                 ...
                 options :
                    {
                        'en':{'publishDate': '','client': ''},
                        'tr':{'publishDate': '','client': ''},
                        'de':{'publishDate': '','client': ''},
                    },
                status: '',
                search: '',
                category_id: '',
        ...
        methods: {
            ...
            let {  id, title,content,seo_title,category_id,options,thumbnail,tags,status,seo_description} = JSON.parse(JSON.stringify(this.data.data))
                    //console.log('active:',this.currentCategory(category_id))
                    this.id = id
                    this.title = title
            ...
            initValues () {
                ...
                this.thumbnail = {'en': 'https://via.placeholder.com/500.png','tr': 'https://via.placeholder.com/500.png','de': 'https://via.placeholder.com/500.png'}
                this.tags = {'en': [],'tr': [],'de': []}
                this.status = 1
                this.category_id = 4
            },
            ...
            getChildCategories() {
                return this.$store.getters['category/getChildCategories'](4) //CATEGORY ID 4 = PORTFOLIOS
            },
            submitData () {
