        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.slug.substring(0, 25) }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.seo_title }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.seo_description }}</p>
              </vs-td>
...
<!--              </vs-td>-->
              ...
              <vs-td>
                <vs-chip :color="getOrderStatusColor(tr.status)" class="product-order-status">{{ tr.status == '1' ? 'Aktif' : 'Taslak'}}</vs-chip>
              </vs-td>
