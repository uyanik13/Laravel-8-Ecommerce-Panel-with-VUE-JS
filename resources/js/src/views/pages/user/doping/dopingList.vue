  ...
  <div id="data-list-list-view" class="data-list-container">
    <div class="vx-col w-full md:w-12/12 mb-base">
      ...
      <vs-tabs position="left" color="danger">
        <vs-tab :label="$t('NewsDoping')"  icon-pack="feather" icon="icon-file-text">
        <div class="vx-row">
        ...
        <vs-tab :label="$t('CaseDoping')"  icon-pack="feather" icon="icon-file-text">
        <div class="vx-row">
        ...
        <vs-tab :label="$t('ProfileDoping')"  icon-pack="feather" icon="icon-file-text">
        <div class="vx-row">
